            ...
            <ul class="navbar-nav mx-auto mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="profilDropdown">
                        <li><a class="dropdown-item" href="{{ route('profil.sambutan') }}">Sambutan Kepala Sekolah</a>
                        </li>
                        <li><a class="dropdown-item" href="{{ route('profil.visi-misi') }}">Visi Misi</a></li>
                        <li><a class="dropdown-item" href="{{ route('profil.struktur-organisasi') }}">Struktur
                                Organisasi</a></li>
                        <li><a class="dropdown-item" href="{{ route('profil.fasilitas') }}">Fasilitas</a></li>
                        <li><a class="dropdown-item" href="{{ route('profil.galeri-sekolah') }}">Galeri Sekolah</a></li>
                        <li><a class="dropdown-item" href="{{ route('profil.guru') }}">Guru & Tenaga Pendidik</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->routeIs('kesiswaan.*') ? 'active' : '' }}"
                        href="#" id="siswaDropdown" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Kesiswaan
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="siswaDropdown">
                        ...
                        <li><a class="dropdown-item"
                                href="{{ route('kesiswaan.ekstrakulikuler') }}">Ekstrakulikuler</a></li>
                    </ul>
                </li>
