@if ($statistik)
    <div class="container statistik" data-aos="fade-up" data-aos-duration="200">
        <div class="row horizontal-card">
            ...
            <!-- KIRI: SAMBUTAN -->
            <div class="col-lg-7 mb-4 mb-md-2">
                <div class="stats-card mt-2 mt-md-0">
                    <h2 class="title">{{ $statistik->title }}</h2>
                    <p class="desc">
                    ...
                    <div class="d-flex align-items-center mt-3">
                        <img src="{{ asset('storage/' . $statistik->photo) }}" class="foto-kepsek"
                            alt="Foto Kepala Sekolah">
                        <div class="kepsek-info ms-3">
                            <h6>{{ $statistik->name }}</h6>
            ...
            <!-- KANAN: DATA SEKOLAH -->
            <div class="col-lg-5">
                <div class="data-card mb-4 mb-md-0">
                    <h4 class="text-center mb-2 mb-md-4 fw-bold">Data Sekolah</h4>
