                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nik"
                                ...
                                value="{{ old('nik') }}" placeholder="16 digit angka" minlength="16" maxlength="16"
                                pattern="\d{16}" title="NIK harus persis 16 digit angka" required>
                        </div>
                        @error('nik')
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email"
                                ...
                                value="{{ old('email') }}" placeholder="namaemail@gmail.com" required>
                        </div>
