    ...
    <div class="section-header mb-4 pb-2 border-bottom">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <p class="text-muted small mb-0">Upload dokumen yang diperlukan (maksimal 2MB per file, format:
                    PDF/JPG/PNG)</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-5 col-lg-4 mb-3 mb-md-0">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted small mb-0">Akta kelahiran dari Dinas Kependudukan dan Catatan
                                    Sipil</p>
                            </div>
                        </div>
                    </div>
