            ...
            <div class="row mb-2">
                <div class="col-12 text-center">
                    ...
                    <p class="section-desc mx-auto">
                        Lulusan SMA Arif Rahman Hakim yang berhasil diterima di berbagai Perguruan Tinggi Negeri (PTN)
                        melalui berbagai jalur seleksi seperti SNBP, SNBT, dan jalur mandiri.
                    </p>
                </div>
            </div>
