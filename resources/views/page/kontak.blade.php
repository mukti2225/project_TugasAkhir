                ...
                <form action="{{ route('kritik-saran.store') }}" method="POST" class="ks-form">
                    ...
                    <div class="ks-form">
                        <div class="ks-form-group">
                            ...
                            <input type="text" id="nama" name="nama"
                                class="ks-input @error('nama') ks-input-error @enderror" value="{{ old('nama') }}"
                        ...
                        <div class="ks-form-group">
                            ...
                            <input type="email" id="email" name="email"
                                class="ks-input @error('email') ks-input-error @enderror" value="{{ old('email') }}"
                                placeholder="" required>
                            @error('email')
                                <span class="ks-error-msg">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="ks-form-group">
                            ...
                            <div class="ks-select-wrapper">
                                <select id="subjek" name="subjek"
                                    class="ks-select @error('subjek') ks-input-error @enderror" required>
                                    <option value="" disabled {{ old('subjek') ? '' : 'selected' }}>Pilih subjek pesan
                                    </option>
                                    <option value="kritik" {{ old('subjek') == 'kritik' ? 'selected' : '' }}>Kritik</option>
                                    <option value="saran" {{ old('subjek') == 'saran' ? 'selected' : '' }}>Saran</option>
                                    <option value="pertanyaan"{{ old('subjek') == 'pertanyaan' ? 'selected' : '' }}>
                                        Pertanyaan
                                    </option>
                        ...
                        <div class="ks-form-group">
                            ...
                            <textarea id="pesan" name="pesan" class="ks-textarea @error('pesan') ks-input-error @enderror" rows="5"
                    ...
                    <button type="submit" class="ks-btn-submit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <path
                                d="M15.854.146a.5.5 0 0 1 .11.54L13.026 8.03A4.5 4.5 0 0 1 8 12.5c-1.8 0-3.4-.99-4.21-2.44L.147 15.854a.5.5 0 0 1-.708-.708L4.5 10.083A4.476 4.476 0 0 1 3.5 8a4.5 4.5 0 0 1 4.5-4.5c.83 0 1.607.225 2.275.618L15.314.036a.5.5 0 0 1 .54.11z" />
                        </svg>
                        Kirim Pesan
                    </button>
            ...
            <div class="ks-card">
                ...
                <div class="ks-map-wrapper">
                    <iframe
                        ...
                        width="100%" height="280" style="border:0; border-radius: 10px;" allowfullscreen=""
                        loading="lazy" referrerpolicy="no-referrer-when-downgrade"
                        title="Lokasi SMA Negeri 27 Jakarta"></iframe>
                </div>
