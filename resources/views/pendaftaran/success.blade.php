                    ...
                    <div class="card border-0 shadow-lg rounded-4">
                        ...
                        <div class="card-body text-center px-4 py-4">
                            <p class="text-muted mb-4">
                                Halo <strong>{{ $pendaftaran->nama }}</strong>, data pendaftaran Anda telah berhasil
                                disimpan. Terima kasih telah mendaftar sebagai Peserta Didik Baru Tahun Ajaran
                                <strong>2026/2027</strong>.
                            </p>

                            <div class="alert alert-info border-0 rounded-3 d-flex align-items-start gap-2 text-start mb-4"
                                role="alert">
                                <i class="bi bi-info-circle-fill text-info mt-1 flex-shrink-0"></i>
                                <div>
                                    <div class="fw-semibold small">Informasi Tambahan</div>
                                    <p class="mb-0 small text-muted">
                                        Harap simpan nomor pendaftaran Anda untuk melakukan Pengecekan Pengumuman kelulusan
                                        di halaman pengecekan.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-footer bg-white border-0 justify-content-center pb-5 pt-2 d-flex flex-wrap gap-2">
                            <a href="{{ route('pendaftaran.download', $pendaftaran->nomor_pendaftaran) }}"
